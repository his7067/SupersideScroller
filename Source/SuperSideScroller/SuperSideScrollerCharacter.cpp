...
void ASuperSideScrollerCharacter::NotifyControllerChanged()
{
...
void ASuperSideScrollerCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...
void ASuperSideScrollerCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ASuperSideScrollerCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
